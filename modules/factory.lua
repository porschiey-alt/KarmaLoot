...
function ns.standardFontStringBuilder(name, setPoint1, parent, parentString, setPoint2, x, y, text, size)
    local f = parent:CreateFontString(name, "ARTWORK", "GameFontNormal")
    f:SetPoint(setPoint1, parentString, setPoint2, x, y)
    f:SetText(text)
    f:SetFont("Interface/Addons/KarmaLoot/fonts/PTSansNarrow.ttf", size)
    f:Show()
    return f
end
...
function ns.standardStatusBarBuilder(parent, setPoint1, x, y, width, height)
    ...
    statusbar:SetStatusBarTexture("Interface\\None")
    ...
    statusbar.value:SetFont("Interface/Addons/KarmaLoot/fonts/PTSansNarrow.ttf", 10)
